  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-brand-950 via-brand-900 to-purple-900 flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="card dark:bg-dark-surface dark:border-dark-border p-6">
          <h1 className="text-xl font-bold text-gray-900 dark:text-dark-text mb-1">Bienvenido de vuelta</h1>
          <p className="text-sm text-gray-500 dark:text-dark-text2 mb-6">Ingresa a tu cuenta</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="input dark:bg-dark-surface2 dark:border-dark-border dark:text-dark-text dark:placeholder-dark-text2/50"
                autoComplete="email"
              />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="input dark:bg-dark-surface2 dark:border-dark-border dark:text-dark-text dark:placeholder-dark-text2/50 pr-10"
                  autoComplete="current-password"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-dark-text2 hover:text-gray-600"
                >
          ...
          <p className="mt-4 text-center text-sm text-gray-500 dark:text-dark-text2">
            ¿No tienes cuenta?{' '}
            <Link href="/auth/register" className="font-semibold text-brand-600 dark:text-brand-300 hover:text-brand-700">
              Regístrate
            </Link>
          </p>
        </div>
